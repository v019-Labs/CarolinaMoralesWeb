// Component from uiverse.io, author of the original component: Marcelo Dolza
...
export function LuxuryGoldButton() {
  ...
  const handleClick = () => {
    ...
    setTimeout(() => {
      window.open("https://wa.me/34651465005", "_blank")
      setIsClicked(false)
    }, 800)
  }
  ...
  return (
    <div className="luxury-button-wrapper" onClick={handleClick}>
        ...
        <div className="wrap">
          ...
          <div className="content">
            <span className="char state-1">
              ...
              <span data-label="G" style={{ "--i": 2 } as React.CSSProperties}>G</span>
              <span data-label="E" style={{ "--i": 3 } as React.CSSProperties}>E</span>
              <span data-label="N" style={{ "--i": 4 } as React.CSSProperties}>N</span>
              <span data-label="D" style={{ "--i": 5 } as React.CSSProperties}>D</span>
      ...
      <style jsx global>{`
        ...
        .luxury-button-wrapper .bg::before,
        .luxury-button-wrapper .bg::after {
          content: "";
          position: absolute;
          inset: 0;
        ...
        .luxury-button-wrapper .bg::before {
          ...
          transition: all 0.3s ease;
          box-shadow:
            -7px 6px 0 0 rgba(139, 101, 8, 0.4),
            -14px 12px 0 0 rgba(139, 101, 8, 0.3),
            -21px 18px 4px 0 rgba(139, 101, 8, 0.25),
            -28px 24px 8px 0 rgba(139, 101, 8, 0.15),
            -35px 30px 12px 0 rgba(139, 101, 8, 0.12),
            -42px 36px 16px 0 rgba(139, 101, 8, 0.08),
            -56px 42px 20px 0 rgba(139, 101, 8, 0.05);
        }
        ...
        .luxury-button-wrapper .outline::before {
          content: "";
          position: absolute;
          inset: 2px;
          width: 120px;
        ...
        .luxury-button-wrapper .char {
          transition: all 0.3s ease;
          display: flex;
          align-items: center;
          justify-content: center;
        }
        .luxury-button-wrapper .char span {
          display: block;
          color: transparent;
          position: relative;
        }

        .luxury-button-wrapper .char.state-1 span {
          animation: charAppear 1.2s ease backwards calc(var(--i) * 0.03s);
        }
        .luxury-button-wrapper .char.state-1 span::before,
        .luxury-button-wrapper .char span::after {
          content: attr(data-label);
          position: absolute;
          color: var(--white);
          text-shadow: -1px 1px 2px var(--gold-500);
          left: 0;
        }
        .luxury-button-wrapper .char span::before {
          opacity: 0;
        ...
        .luxury-button-wrapper .char.state-2 span::after {
          opacity: 1;
        }

        .luxury-button-wrapper .icon {
          animation: resetArrow 0.8s cubic-bezier(0.7, -0.5, 0.3, 1.2) forwards;
          z-index: 10;
        }
        .luxury-button-wrapper .icon div,
        .luxury-button-wrapper .icon div::before,
        .luxury-button-wrapper .icon div::after {
          height: 3px;
          border-radius: 1px;
        ...
        .luxury-button-wrapper .icon div {
          position: relative;
          width: 24px;
          box-shadow: -2px 2px 5px var(--gold-400);
          transform: scale(0.9);
        ...
        .luxury-button-wrapper .icon div::before {
          ...
          top: 1px;
          box-shadow: 1px -2px 3px -1px var(--gold-400);
        ...
        .luxury-button-wrapper .button:hover .words {
          opacity: 1;
        }
        .luxury-button-wrapper .button:hover .words span {
          animation-play-state: running;
        }

        .luxury-button-wrapper .button:hover .char.state-1 span::before {
          animation: charAppear 0.7s ease calc(var(--i) * 0.03s);
        }

        .luxury-button-wrapper .button:hover .char.state-1 span::after {
          opacity: 1;
          animation: charDisappear 0.7s ease calc(var(--i) * 0.03s);
        }

        .luxury-button-wrapper .button:hover .wrap {
          transform: translate(8px, -8px);
        }

        .luxury-button-wrapper .button:hover .outline {
          opacity: 1;
        }

        .luxury-button-wrapper .button:hover .outline::before,
        .luxury-button-wrapper .button:hover .icon div::before,
        .luxury-button-wrapper .button:hover .icon div::after,
        .luxury-button-wrapper .button:hover .icon div {
          animation-play-state: running;
        }

        .luxury-button-wrapper .button:active .bg::before,
        .luxury-button-wrapper .button.is-clicked .bg::before {
          filter: blur(5px);
          opacity: 0.7;
          box-shadow:
            -7px 6px 0 0 rgba(139, 101, 8, 0.4),
            -14px 12px 0 0 rgba(139, 101, 8, 0.25),
            -21px 18px 4px 0 rgba(139, 101, 8, 0.15);
        }
        .luxury-button-wrapper .button:active .content,
        .luxury-button-wrapper .button.is-clicked .content {
          box-shadow:
            inset -1px 12px 8px -5px rgba(139, 101, 8, 0.4),
            inset 0px -3px 8px 0px var(--gold-200);
        }

        .luxury-button-wrapper .button:active .words,
        .luxury-button-wrapper .button:active .outline,
        .luxury-button-wrapper .button.is-clicked .words,
        .luxury-button-wrapper .button.is-clicked .outline {
          opacity: 0;
        }

        .luxury-button-wrapper .button:active .wrap,
        .luxury-button-wrapper .button.is-clicked .wrap {
          transform: translate(3px, -3px);
        }

        .luxury-button-wrapper .button:active .splash,
        .luxury-button-wrapper .button.is-clicked .splash {
          animation: splash 0.8s cubic-bezier(0.3, 0, 0, 1) forwards 0.05s;
        }

        .luxury-button-wrapper .button:focus .path,
        .luxury-button-wrapper .button.is-clicked .path {
          animation: path 1.6s ease forwards 0.2s;
        }

        .luxury-button-wrapper .button:focus .icon,
        .luxury-button-wrapper .button.is-clicked .icon {
          animation: arrow 1s cubic-bezier(0.7, -0.5, 0.3, 1.5) forwards;
        }

        .luxury-button-wrapper .char.state-2 span::after,
        .luxury-button-wrapper .button:focus .char.state-1 span,
        .luxury-button-wrapper .button.is-clicked .char.state-1 span {
          animation: charDisappear 0.5s ease forwards calc(var(--i) * 0.03s);
        }

        .luxury-button-wrapper .button:focus .char.state-2 span::after,
        .luxury-button-wrapper .button.is-clicked .char.state-2 span::after {
